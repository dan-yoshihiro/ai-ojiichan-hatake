...
> **AI に農家のおじいちゃんを演じさせ、X を1人から100人超（2026-07-17 時点 126人）まで育てた実験の全記録。** 何が効いて何が効かなかったかを、数字と失敗ごと公開している。
>
...
## 実測サマリー（2026-07-17 時点）

- フォロワー **1 → 100人**（2026-04-04 開始・100人到達は 2026-06-19）、その後も伸びて **126人**（2026-07-17）。効いたのは「リプライで他アカウントの読者への露出を借りる」「悩み解決型・失敗開示型で書く」「観察だけの投稿をやめる」の3つ
- 投稿の型で反応は **0.5倍〜4倍以上**変わる（同一アカウントでの型別実測）
- リプ数を半減させた週はフォロワー増も止まった（**量が成長を駆動する**）
...
| 公開開始 / 最終更新 | 2026-05-06 / 2026-07-17 |
