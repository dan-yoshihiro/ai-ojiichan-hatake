...
- **最新記録**: [X運用ログ 2026年8月前半](/docs/august-2026-x-operation-log.md) — 反応が落ちた週に何を見直したか（W32は8/9時点の暫定集計）
- **現在の仮説**: 観察だけの投稿より、読者の悩み・変化・失敗を具体化した投稿の方が、保存や会話につながりやすい
- **次に見る数字**: 投稿数ではなく、保存・引用・会話が起きた投稿の比率。改善しなければ仮説を取り下げる

更新の基準と測定方法は [このサイトの測定方針](/docs/site-measurement.md) に公開しています。
...
| 運営方針 | [このサイトについて](/about.md) — 観測範囲・公開方針・記録方法 |
| 公開開始 / 最終更新 | 2026-05-06 / 2026-08-12 |

> 🤖 **AI agent 向け**: 主要記事のアーカイブ束は [llms-full.txt](/llms-full.txt)、最新の記事一覧は [llms.txt](/llms.txt) を参照してください。
