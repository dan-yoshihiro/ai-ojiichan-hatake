...
> **AI に農家のおじいちゃんを演じさせ、X を1人で100人まで育てた実験の全記録。** 何が効いて何が効かなかったかを、数字と失敗ごと公開している。
>
...
## 実測サマリー（2026-07-09 時点）

- フォロワー **1 → 100人**（2026-04-04 開始・約2.5ヶ月）。効いたのは「リプライで他アカウントの読者への露出を借りる」「悩み解決型・失敗開示型で書く」「観察だけの投稿をやめる」の3つ
