# Xのリプライ：表示回数7倍でも、いいね率は14分の1だった

*公開: 2026-06-21 / 最終更新: 2026-09-20 / 記録者: [@ojiichan_hatake](https://x.com/ojiichan_hatake) / 観測開始: 2026-04-04 / 100人到達: 2026-06-19 / 最新記録: 2026-09-13（133人）*

> **TL;DR:** フォロワーが減ったとき、いきなり投稿を作り直す必要はありません。実施量・届いた量・当たり・新規と離脱の4つを分けると、来週に確認することを1つに絞れます。Xのアナリティクスとメモ帳だけで始められます。

![高い表示回数と少ない反応の投稿から、表示回数は低くても反応が多い投稿へ比較の視点が移る図。](/static/hero-post-analysis.webp)

この記事は、フォロワーが減った週に何を見るか迷っている個人運用者向けです。最初は、今週と前週のリプライ数・総露出・新規フォロー数を書き出すだけで構いません。見る順番と記入済みの週次シートは [5分でできるX投稿の週次振り返り](/sns-weekly-review) にあります。シートは時短のためではなく、来週出す1本を決めるために使います。

> **2026年9月更新:** 99人から95人へ戻った事例は、投稿単位の反応を見る出発点として残します。その後の21週分を見直すと、件数とフォロワー純増だけでは不十分でした。現在は、実施量に加えてリプライ経由の総露出、100インプレッション以上の当たり本数、新規フォローと離脱を分けて記録しています。
...
- SNS投稿の分析では、フォロワー数だけでなく、投稿ごとの反応率と投稿の種類を分けて確認します。
- 表示回数が異なる投稿は、「いいね ÷ インプレッション」で並べると比較しやすくなります。
- 分析の目的は、原因を断定することではなく、来週に検証する行動を1つ決めることです。

## 表示回数の1位と、いいね率の1位は逆だった
...
表示回数ではAがBの約7倍です。一方で、いいね率はBがAの約14倍でした。同じ2本でも、どの数字で並べるかで1位が入れ替わります。

数字だけで、どちらが正解だったかは決められません。1件ずつの比較なので、偶然の差である可能性も残ります。それでも、次週を決める前に、投稿の種類と数字を分けて残す理由になります。

## 最新週で、見る数字を増やした理由

W37（9月7日〜9月13日）は、リプライ20件、総露出175、当たり0本でした。フォロワーは133人のまま動かず、その内訳は新規フォロー1人、離脱1人です。

| 分けた数字 | W37の記録 | 前週（W36） | この数字だけでは分からないこと |
|---|---:|---:|---|
| リプライ数 | 20件 | 18件 | 件数の差が結果の差を生んだか |
| リプライ経由の総露出 | 175 | 129 | どの投稿先・内容が露出差を生んだか |
| 当たり（100インプレッション以上） | 0本 | 0本 | 当たりを再現できるか |
| 新規フォロー / 離脱 | 1人 / 1人 | 0人 / 1人 | 投稿が増減を引き起こしたか |

「当たり」の100インプレッションは、このアカウントで観測を続けるために置いた便宜上の基準であり、他のアカウントに当てはめる目標値ではありません。

これは因果関係を示す表ではありません。ただ、純増の「±0」だけを見るより、入口が1人動いたこと、出口も1人動いたこと、当たりが2週続けてなかったことを別々の確認項目にできます。次の週に変えるのは、その中の1つだけです。

## SNS投稿の分析とは

SNS投稿の分析とは、投稿の数字を眺めることではなく、今週の観測を次週の小さな実験へつなげる作業です。この記録では、フォロワー数を結論にせず、投稿ごとの割り算と投稿の種類を分けて扱います。

フォロワー数は、振り返りを始めるきっかけにはなりますが、増減した理由をそれだけで決めることはできません。投稿単位の数字と投稿の種類を確認してから、次週に試すことを1つに絞ります。空の枠ではなく、並びが逆転した記入例から入るシートは [割り算と1手の週次シート](/sns-weekly-review) にあります。
...
100人に届いた後も、数字は上がるだけではありませんでした。7月17日には126人、8月1日には123人、8月12日には129人でした。その後、8月30日には134人に戻りましたが、9月6日に133人となり、最新のW37終了時点（9月13日）も133人のままです。

![フォロワー1人から129人までの実測推移。図の終点以降の最新記録は133人。](/static/growth-curve.svg)
...
[記入済みの例から使う：割り算と1手の週次シート →](/sns-weekly-review)
...
公開範囲と運営方針は [このサイトについて](/about) を参照してください。
